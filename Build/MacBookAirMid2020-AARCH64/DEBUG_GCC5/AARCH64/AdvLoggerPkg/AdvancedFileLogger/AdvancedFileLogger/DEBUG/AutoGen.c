...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x06e49122, 0x4ef4, 0x45fe, {0x97, 0x66, 0xe2, 0xea, 0xf2, 0xf9, 0x47, 0x2f}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AdvancedFileLogger";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAdvancedFileLoggerWriteLogFiles = { 0xc60e894d, 0x29a4, 0x4e0b, {0xb7, 0x44, 0x77, 0x84, 0x22, 0x6e, 0x81, 0x80 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAdvancedFileLoggerPolicyGuid = { 0x6c3fd4f1, 0xb596, 0x438e, { 0x8a, 0xb8, 0x53, 0xf1, 0xc, 0x9c, 0x27, 0x74 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAdvLoggerPkgTokenSpaceGuid = { 0x11aaf2c3, 0xc657, 0x4137, {0xbd, 0xa8, 0xd1, 0xe5, 0x88, 0x22, 0xb8, 0x36 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAdvancedLoggerProtocolGuid = { 0x434f695c, 0xef26, 0x4a12, {0x9e, 0xba, 0xdd, 0xef, 0x00, 0x97, 0x49, 0x7c }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPolicyProtocolGuid = { 0xd7c9b744, 0x13a5, 0x4377, { 0x8d, 0x2a, 0x6b, 0x37, 0xad, 0x1f, 0xd8, 0x2a } };

// Definition of SkuId Array
GLOBAL_REMOVE_IF_UNREFERENCED UINT64 _gPcd_SkuId_Array[] = {0x0};

// Definition of PCDs used in this module
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdAdvancedLoggerPages = _PCD_VALUE_PcdAdvancedLoggerPages;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdAdvancedFileLoggerForceEnable = _PCD_VALUE_PcdAdvancedFileLoggerForceEnable;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdAdvancedFileLoggerFlush = _PCD_VALUE_PcdAdvancedFileLoggerFlush;
  ...
  )
{
  ...
  Status = AdvancedLoggerAccessLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);

  Status = ReportStatusCodeLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);

  Status = PolicyLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
  ...
  )
{
  ...
  Status = PolicyLibDestructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
...
{
  return AdvancedFileLoggerEntry (ImageHandle, SystemTable);
}
