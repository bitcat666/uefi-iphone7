...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xf7b773c7, 0x660a, 0x4da6, {0xb6, 0x41, 0x75, 0xe9, 0xee, 0x06, 0xbd, 0x41}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AppleDartIoMmuDxe";
...
{
  return AppleDartIoMmuDxeInitialize (ImageHandle, SystemTable);
}
