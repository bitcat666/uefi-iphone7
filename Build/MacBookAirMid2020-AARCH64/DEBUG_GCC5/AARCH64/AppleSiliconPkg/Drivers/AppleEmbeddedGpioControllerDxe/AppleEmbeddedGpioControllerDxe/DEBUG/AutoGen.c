...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x15d3c0d1, 0x346b, 0x462d, {0xa4, 0x0c, 0xec, 0xc0, 0x1f, 0x82, 0x99, 0xfa}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AppleEmbeddedGpioControllerDxe";
...
{
  return AppleEmbeddedGpioControllerDxeInitialize (ImageHandle, SystemTable);
}
