...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1d0fc441, 0x75eb, 0x4464, {0x8f, 0x11, 0xbe, 0xab, 0x62, 0x85, 0x81, 0xd1}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AppleSiliconPciPlatformDxe";
...
{
  return AppleSiliconPciPlatformDxeInitialize (ImageHandle, SystemTable);
}
