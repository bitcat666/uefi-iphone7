...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xa7a8b3f7, 0xb8bb, 0x42ff, {0xa5, 0xd1, 0x07, 0xce, 0x43, 0x73, 0x44, 0x61}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AppleUsbTypeCBringupDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdAppleSocIdentifier = _PCD_VALUE_PcdAppleSocIdentifier;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdAppleNumDwc3Controllers = _PCD_VALUE_PcdAppleNumDwc3Controllers;
...
{
  return AppleUsbTypeCBringupDxeInitialize (ImageHandle, SystemTable);
}
