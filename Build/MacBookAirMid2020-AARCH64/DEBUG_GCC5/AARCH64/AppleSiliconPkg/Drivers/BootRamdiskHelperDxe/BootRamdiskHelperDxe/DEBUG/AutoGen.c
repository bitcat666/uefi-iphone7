...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x69b5dbd8, 0x92c0, 0x492c, {0x85, 0x9f, 0x72, 0x56, 0xd5, 0x10, 0x0d, 0x2a}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BootRamdiskHelperDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAppleSiliconPkgEmbeddedRamdiskGuid = { 0x650b7cd0, 0x94f8, 0x46cc, { 0x88, 0xde, 0x8c, 0x19, 0x9d, 0x41, 0xed, 0xa3} };
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdInitializeRamdisk = _PCD_VALUE_PcdInitializeRamdisk;
...
{
  return BootRamdiskHelperDxeInitialize (ImageHandle, SystemTable);
}
