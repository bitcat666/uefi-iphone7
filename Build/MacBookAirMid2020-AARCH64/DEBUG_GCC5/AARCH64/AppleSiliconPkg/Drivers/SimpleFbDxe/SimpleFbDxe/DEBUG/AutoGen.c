...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdFrameBufferWidth = _PCD_VALUE_PcdFrameBufferWidth;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdFrameBufferHeight = _PCD_VALUE_PcdFrameBufferHeight;
