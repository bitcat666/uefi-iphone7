...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x58018fb9, 0x0e53, 0x429a, {0xad, 0xd1, 0x87, 0xfe, 0xd5, 0x2c, 0x85, 0x59}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmBiosTableDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdAdtPointer = _PCD_VALUE_PcdAdtPointer;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdBootArgsPointer = _PCD_VALUE_PcdBootArgsPointer;
...
{
  return SmBiosTableDxeInitialize (ImageHandle, SystemTable);
}
