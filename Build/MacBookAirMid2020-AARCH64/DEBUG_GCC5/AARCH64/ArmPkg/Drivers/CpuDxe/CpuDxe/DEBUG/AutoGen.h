...
#define STACK_COOKIE_VALUE 0x237D593850D2E657ULL
...
#define _PCD_TOKEN_PcdRemapUnusedMemoryNx  0U
#define _PCD_SIZE_PcdRemapUnusedMemoryNx 1
#define _PCD_GET_MODE_SIZE_PcdRemapUnusedMemoryNx  _PCD_SIZE_PcdRemapUnusedMemoryNx 
#define _PCD_VALUE_PcdRemapUnusedMemoryNx  ((BOOLEAN)1U)
extern const  BOOLEAN  _gPcd_FixedAtBuild_PcdRemapUnusedMemoryNx;
#define _PCD_GET_MODE_BOOL_PcdRemapUnusedMemoryNx  _gPcd_FixedAtBuild_PcdRemapUnusedMemoryNx
//#define _PCD_SET_MODE_BOOL_PcdRemapUnusedMemoryNx  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD
