...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1DD0D079, 0x406A, 0x4B5B, {0xAF, 0x39, 0x62, 0xD8, 0xF1, 0x10, 0xF8, 0x35}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NullAuthManager";
