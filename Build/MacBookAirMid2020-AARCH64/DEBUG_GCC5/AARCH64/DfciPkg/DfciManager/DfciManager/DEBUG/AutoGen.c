...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x07f1b357, 0x4270, 0x4122, {0xa3, 0x2a, 0x7e, 0xab, 0x3c, 0x01, 0x3b, 0xac}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DfciManager";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gDfciAuthProvisionVarNamespace = { 0xDE6A8726, 0x05DF, 0x43CE, { 0xB6, 0x00, 0x92, 0xBD, 0x5D, 0x28, 0x6C, 0xFD }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMuVarPolicyDxePhaseGuid = { 0xecf590c6, 0xf8f9, 0x4387, { 0x84, 0x22, 0x48, 0x6e, 0x3c, 0xcd, 0x8b, 0x20 }};
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gDfciApplyIdentityProtocolGuid = { 0x74f90a71, 0xcfea, 0x4842, {0x8a, 0x45, 0xf7, 0x98, 0x23, 0x45, 0x9d, 0x4a} };
...
{
  return DfciManagerEntry (ImageHandle, SystemTable);
}
