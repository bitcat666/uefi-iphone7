...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB5FD279E, 0x779D, 0x4831, {0xAD, 0xEE, 0x41, 0xCC, 0x49, 0xFA, 0xF6, 0x52}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HidKeyboardDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gHidKeyboardLayoutPackageGuid = {0x57adcfa9, 0xc08a, 0x40b9, {0x86, 0x87, 0x65, 0xe2, 0xec, 0xe0, 0xe5, 0xe1}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gHidKeyboardLayoutKeyGuid = {0xdcafaba8, 0xcde5, 0x40a1, {0x9a, 0xd3, 0x48, 0x76, 0x44, 0x71, 0x7e, 0x47}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gHidPkgTokenSpaceGuid = {0x347d3cd6, 0xdf7d, 0x4397, {0xa3, 0x7a, 0x4c, 0x0f, 0x46, 0xdb, 0xdb, 0xff}};
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gHidKeyboardProtocolGuid = { 0x540937ca, 0xcac9, 0x4d5c, { 0x83, 0xa9, 0xa8, 0x08, 0x45, 0x79, 0x40, 0xaf }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdDisableDefaultKeyboardLayoutInHidKbDriver = _PCD_VALUE_PcdDisableDefaultKeyboardLayoutInHidKbDriver;
...
{
  return HIDKeyboardDriverEntryPoint (ImageHandle, SystemTable);
}
