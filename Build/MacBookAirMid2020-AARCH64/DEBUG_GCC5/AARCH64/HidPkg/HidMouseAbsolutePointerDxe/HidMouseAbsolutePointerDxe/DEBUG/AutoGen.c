...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x99710012, 0x4230, 0x4842, {0x97, 0x12, 0xB9, 0x78, 0x5B, 0x72, 0x38, 0x12}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HidMouseAbsolutePointerDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gHidPointerProtocolGuid = { 0x80b5ee6e, 0xcbd8, 0x43ae, { 0xb6, 0xac, 0x10, 0x91, 0x7b, 0x25, 0x35, 0xb7 }};
...
{
  return HidMouseAbsolutePointerDriverBindingEntryPoint (ImageHandle, SystemTable);
}
