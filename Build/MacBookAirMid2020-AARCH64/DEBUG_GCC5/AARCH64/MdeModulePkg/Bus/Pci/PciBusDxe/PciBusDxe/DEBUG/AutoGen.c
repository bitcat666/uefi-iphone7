...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdDeferBME = _PCD_VALUE_PcdDeferBME;
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdDisableBMEonEBS = _PCD_VALUE_PcdDisableBMEonEBS;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdPcieInitializeMps = _PCD_VALUE_PcdPcieInitializeMps;
