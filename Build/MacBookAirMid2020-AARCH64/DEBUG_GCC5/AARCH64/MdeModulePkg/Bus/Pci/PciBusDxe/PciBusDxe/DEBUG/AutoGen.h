...
#define _PCD_TOKEN_PcdDeferBME  0U
#define _PCD_SIZE_PcdDeferBME 1
#define _PCD_GET_MODE_SIZE_PcdDeferBME  _PCD_SIZE_PcdDeferBME 
#define _PCD_VALUE_PcdDeferBME  ((BOOLEAN)1U)
extern const  BOOLEAN  _gPcd_FixedAtBuild_PcdDeferBME;
#define _PCD_GET_MODE_BOOL_PcdDeferBME  _gPcd_FixedAtBuild_PcdDeferBME
//#define _PCD_SET_MODE_BOOL_PcdDeferBME  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD
...
#define _PCD_TOKEN_PcdDisableBMEonEBS  0U
#define _PCD_SIZE_PcdDisableBMEonEBS 1
#define _PCD_GET_MODE_SIZE_PcdDisableBMEonEBS  _PCD_SIZE_PcdDisableBMEonEBS 
#define _PCD_VALUE_PcdDisableBMEonEBS  1U
extern const  BOOLEAN  _gPcd_FixedAtBuild_PcdDisableBMEonEBS;
#define _PCD_GET_MODE_BOOL_PcdDisableBMEonEBS  _gPcd_FixedAtBuild_PcdDisableBMEonEBS
//#define _PCD_SET_MODE_BOOL_PcdDisableBMEonEBS  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD

#define _PCD_TOKEN_PcdPcieInitializeMps  0U
#define _PCD_SIZE_PcdPcieInitializeMps 1
#define _PCD_GET_MODE_SIZE_PcdPcieInitializeMps  _PCD_SIZE_PcdPcieInitializeMps 
#define _PCD_VALUE_PcdPcieInitializeMps  0U
extern const  BOOLEAN  _gPcd_FixedAtBuild_PcdPcieInitializeMps;
#define _PCD_GET_MODE_BOOL_PcdPcieInitializeMps  _gPcd_FixedAtBuild_PcdPcieInitializeMps
//#define _PCD_SET_MODE_BOOL_PcdPcieInitializeMps  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD
