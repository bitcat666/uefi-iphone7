...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPciBusMin = _PCD_VALUE_PcdPciBusMin;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPciBusMax = _PCD_VALUE_PcdPciBusMax;
...
#define _PCD_VALUE_PcdPciIoSize  0x00010000ULL
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPciMmio32Base = _PCD_VALUE_PcdPciMmio32Base;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPciMmio32Size = _PCD_VALUE_PcdPciMmio32Size;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPciMmio64Base = _PCD_VALUE_PcdPciMmio64Base;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPciMmio64Size = _PCD_VALUE_PcdPciMmio64Size;
