...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gDxeMemoryProtectionSettingsGuid = { 0x9ABFD639, 0xD1D0, 0x4EFF, { 0xBD, 0xB6, 0x7E, 0xC4, 0x19, 0x0D, 0x17, 0xD5 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMemoryProtectionSpecialRegionHobGuid = { 0xBFCC1325, 0x3BFE, 0x469A, { 0x9A, 0xAC, 0x0C, 0x99, 0x0E, 0x4E, 0xC9, 0xF1 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gCompatibilityModeActivatedEventGuid = { 0x209BA820, 0xCE32, 0x49E1, { 0x95, 0xAE, 0x39, 0x43, 0x3D, 0xEF, 0xD5, 0xEE } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gDebuggerControlHobGuid = { 0x96ad286c, 0xac0f, 0x4ba1, {0x97, 0x34, 0x6c, 0x9f, 0x3c, 0xad, 0x90, 0x4c }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID DebuggerFeaturePkgTokenSpaceGuid = { 0xbf004bc2, 0xda8c, 0x4e44, {0xb4, 0x70, 0xd6, 0x9c, 0x28, 0x6d, 0x71, 0x2d }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gInternalEventServicesProtocolGuid = {0x7ecd162a, 0xc664, 0x11ec, { 0x9d, 0x64, 0x02, 0x42, 0xac, 0x12, 0x00, 0x02 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMemoryProtectionDebugProtocolGuid = { 0xe8150630, 0x6366, 0x4294, { 0xa3, 0x47, 0x89, 0x2c, 0x3a, 0x7d, 0xe4, 0xaf } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMemoryProtectionSpecialRegionProtocolGuid = { 0x47BF7F78, 0x0B53, 0x487B, {0xA2, 0xFE, 0x42, 0xE7, 0x09, 0x87, 0x54, 0x5C } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkiiGcdSyncCompleteProtocolGuid = { 0x650B7F40, 0x6564, 0x4FA9, { 0x93, 0x75, 0xCD, 0x6B, 0x52, 0x1B, 0x6E, 0x50 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdInternalEventServicesEnabled = _PCD_VALUE_PcdInternalEventServicesEnabled;
...
#define _PCD_VALUE_PcdMonitorConduitHvc  0U
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdMonitorConduitHvc = _PCD_VALUE_PcdMonitorConduitHvc;
...
#define _PCD_VALUE_PcdForceEnableDebugger  0U
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdForceEnableDebugger = _PCD_VALUE_PcdForceEnableDebugger;
...
#define _PCD_VALUE_PcdEnableWindbgWorkarounds  1U
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdEnableWindbgWorkarounds = _PCD_VALUE_PcdEnableWindbgWorkarounds;
  ...
  )
{
  ...
  Status = DxeMemoryProtectionHobLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
