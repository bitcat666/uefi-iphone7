...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMsWheaRSCDataTypeGuid = { 0x91deea05, 0x8c0a, 0x4dcd, { 0xb9, 0x1e, 0xf2, 0x1c, 0xa0, 0xc6, 0x84, 0x5 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gOemBootNVVarGuid = { 0x9b09b8c1, 0x3cc0, 0x4f3b, { 0xa6, 0xcb, 0xa0, 0x21, 0x4b, 0x7f, 0x4c, 0x63 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMsBootManagerSettingsGuid = { 0x5f95741e, 0xcd01, 0x441c, { 0x8f, 0xab, 0xad, 0x05, 0xfb, 0x79, 0x39, 0x19 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMsStartOfBdsNotifyGuid = { 0x056e730a, 0x2ac9, 0x4f9c, {0xa7, 0x92, 0x1f, 0x3f, 0x1a, 0x48, 0xa2, 0x4d}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMuReadyToProcessCapsulesNotifyGuid = { 0x2AB1C860, 0xE697, 0x4EDE, {0x8C, 0x0F, 0x65, 0xCD, 0x6E, 0x44, 0x44, 0x35}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMsNetworkDelayProtocolGuid = { 0xff7d36aa, 0x96a5, 0x46c4, { 0xb1, 0x66, 0xfe, 0x18, 0xd2, 0x93, 0x26, 0x06 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gTpmPpProtocolGuid = { 0x4cebaa75, 0x2ebc, 0x4cc2, { 0x9b, 0xb3, 0x87, 0x1e, 0x3d, 0x2c, 0x18, 0x75 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdFirmwareVendor[19] = {65, 112, 112, 108, 101, 87, 79, 65, 32, 68, 101, 118, 101, 108, 111, 112, 101, 114, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdFirmwareVendor = 38;
...
#define _PCD_VALUE_PcdUefiVersionNumber  00000000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdUefiVersionNumber = _PCD_VALUE_PcdUefiVersionNumber;
...
#define _PCD_VALUE_PcdUefiBuildDate  00000000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdUefiBuildDate = _PCD_VALUE_PcdUefiBuildDate;
...
#define _PCD_VALUE_PcdSettingsManagerInstallProvider  ((BOOLEAN)0U)
...
#define _PCD_VALUE_PcdEnableIPv6Boot  0x1U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEnableIPv6Boot = _PCD_VALUE_PcdEnableIPv6Boot;
...
#define _PCD_VALUE_PcdEnableAltBoot  0x1U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEnableAltBoot = _PCD_VALUE_PcdEnableAltBoot;
...
#define _PCD_VALUE_PcdEnableBootOrderLock  0x0U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEnableBootOrderLock = _PCD_VALUE_PcdEnableBootOrderLock;
...
#define _PCD_VALUE_PcdEnableUsbBoot  0x1U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEnableUsbBoot = _PCD_VALUE_PcdEnableUsbBoot;
...
#define _PCD_VALUE_PcdStartNetwork  0x0U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdStartNetwork = _PCD_VALUE_PcdStartNetwork;
...
#define _PCD_VALUE_PcdEnableMemMapOutput  0x0U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEnableMemMapOutput = _PCD_VALUE_PcdEnableMemMapOutput;
...
#define _PCD_VALUE_PcdEnableMemMapTypes  0x3FFFU
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdEnableMemMapTypes = _PCD_VALUE_PcdEnableMemMapTypes;
...
#define _PCD_VALUE_PcdPowerAndThermalRetries  0U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPowerAndThermalRetries = _PCD_VALUE_PcdPowerAndThermalRetries;
...
#define _PCD_VALUE_PcdShutdownGraphicDisplayTime  50000000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdShutdownGraphicDisplayTime = _PCD_VALUE_PcdShutdownGraphicDisplayTime;
...
#define _PCD_VALUE_PcdThermalControlRetryWait  600000000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdThermalControlRetryWait = _PCD_VALUE_PcdThermalControlRetryWait;
...
#define _PCD_VALUE_PcdEnableMemMapDumpOutput  0x0U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEnableMemMapDumpOutput = _PCD_VALUE_PcdEnableMemMapDumpOutput;
...
#define _PCD_VALUE_PcdLowResolutionInternalShell  0U
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdLowResolutionInternalShell = _PCD_VALUE_PcdLowResolutionInternalShell;
  ...
  )
{
  ...
  Status = MsBootManagerSettingsConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
