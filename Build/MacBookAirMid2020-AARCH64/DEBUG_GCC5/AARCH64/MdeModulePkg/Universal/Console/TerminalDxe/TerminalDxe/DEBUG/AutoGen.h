...
#define _PCD_TOKEN_PcdTerminalKeyboardTimerInterval  0U
#define _PCD_SIZE_PcdTerminalKeyboardTimerInterval 4
#define _PCD_GET_MODE_SIZE_PcdTerminalKeyboardTimerInterval  _PCD_SIZE_PcdTerminalKeyboardTimerInterval 
#define _PCD_VALUE_PcdTerminalKeyboardTimerInterval  0x00000000U
extern const  UINT32  _gPcd_FixedAtBuild_PcdTerminalKeyboardTimerInterval;
#define _PCD_GET_MODE_32_PcdTerminalKeyboardTimerInterval  _gPcd_FixedAtBuild_PcdTerminalKeyboardTimerInterval
//#define _PCD_SET_MODE_32_PcdTerminalKeyboardTimerInterval  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD
