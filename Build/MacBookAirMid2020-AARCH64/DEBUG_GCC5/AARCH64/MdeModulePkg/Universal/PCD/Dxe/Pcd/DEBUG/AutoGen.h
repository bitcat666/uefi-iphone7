...
#define STACK_COOKIE_VALUE 0x23189F83F09975EBULL
...
#define DXE_EXMAPPING_TABLE_SIZE           5U
#define DXE_EX_TOKEN_NUMBER                5U
...
typedef struct {
  ...
  UINT8              PcdPostBackgroundColoringSkipCount_89d2dae8_fb96_4e83_9860_5cdf279df3c1[1];


  BOOLEAN            PcdSKUEnableDfci_3e8b05f6_dd48_413c_87b9_057e6a0c0f93[1];
...
typedef struct {
  ...
  UINT64   PcdCurrentPointerState_89d2dae8_fb96_4e83_9860_5cdf279df3c1[1];

  UINT32   PcdDeviceStateBitmask_a1aff049_fdeb_442a_b320_13ab4cb72bbc[1];

  UINT16   PcdSetNvStoreDefaultId_a1aff049_fdeb_442a_b320_13ab4cb72bbc[1];


  BOOLEAN  PcdSetupUiReducedFunction_3e8b05f6_dd48_413c_87b9_057e6a0c0f93[1];
