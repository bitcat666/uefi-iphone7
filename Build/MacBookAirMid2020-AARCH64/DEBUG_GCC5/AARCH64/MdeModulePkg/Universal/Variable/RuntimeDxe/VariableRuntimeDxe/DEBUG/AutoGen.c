...
#define _PCD_VALUE_PcdMaxMemoryTypeInfoPages  0x60000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdMaxMemoryTypeInfoPages = _PCD_VALUE_PcdMaxMemoryTypeInfoPages;
  ...
  )
{
  ...
  Status = MemoryTypeInfoSecVarCheckLibConstructor ();
