...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x16a5dd36, 0x4c29, 0x4e85, {0xb0, 0xb9, 0xc0, 0x58, 0x83, 0x75, 0x3d, 0xe7}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MsUiThemeProtocol";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMsUiThemeHobGuid = {  0xb07c8481, 0xb02f, 0x44ca, {0xa9, 0x09, 0x64, 0xf8, 0xcd, 0x47, 0x0b, 0x6f }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdUiThemeInDxe = _PCD_VALUE_PcdUiThemeInDxe;
...
{
  return MsUiThemeProtocolEntry (ImageHandle, SystemTable);
}
