...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x917C56F2, 0x2FE3, 0x498F, {0xAF, 0xFB, 0x87, 0xAC, 0x0E, 0x19, 0xFE, 0x5E}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OnScreenKeyboardDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gOSKDevicePathGuid = {0xad603516, 0xd94a, 0x425e, {0x9b, 0x42, 0x0b, 0x55, 0xfd, 0xdb, 0xd8, 0xa1}};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSmallAssetMaxScreenWidth = _PCD_VALUE_PcdSmallAssetMaxScreenWidth;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdEnableTypematicOSK = _PCD_VALUE_PcdEnableTypematicOSK;
...
{
  return OSKDriverEntryPoint (ImageHandle, SystemTable);
}
