...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x328AC7D1, 0x6D2B, 0x4F6B, {0x8A, 0x2D, 0xEA, 0x63, 0x02, 0xA6, 0x2F, 0x60}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HwErrorBert";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiFirmwareErrorSectionGuid = { 0x81212a96, 0x09ed, 0x4996, { 0x94, 0x71, 0x8d, 0x72, 0x9c, 0x8e, 0x69, 0xed }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdAcpiDefaultOemId[6] = {65, 112, 112, 108, 101, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdAcpiDefaultOemId = 6;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdBertEntriesVariableNames[1] = {0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdBertEntriesVariableNames = 2;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdBertEntriesVariableGuid[16] = {0xDD, 0x6B, 0x4E, 0x41, 0x7B, 0xE4, 0xCC, 0x47, 0xB2, 0x44, 0xBB, 0x61, 0x02, 0x0C, 0xF5, 0x16};
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdBertEntriesVariableGuid = 16;
...
{
  return HwErrorBertEntry (ImageHandle, SystemTable);
}
