...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x995F045B, 0x0265, 0x46A4, {0x8D, 0x21, 0x00, 0x12, 0x11, 0xA2, 0x4A, 0x4F}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MsWheaReportDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMuTelemetrySectionTypeGuid = { 0x85183a8b, 0x9c41, 0x429c, { 0x93, 0x9c, 0x5c, 0x3c, 0x08, 0x7c, 0xa2, 0x80 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMsWheaReportServiceGuid = { 0x8efebc4a, 0x5222, 0x409c, { 0xa5, 0x9f, 0x6f, 0x06, 0xdd, 0xb7, 0x96, 0x78 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiEventNotificationTypeBootGuid = { 0x3D61A466, 0xAB40, 0x409a, { 0xA6, 0x98, 0xF3, 0x62, 0xD4, 0x64, 0xB3, 0x8F }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMsWheaReportRecordIDGuid = { 0x8efeb64a, 0x5322, 0x429c, { 0xa5, 0x9f, 0x6f, 0x16, 0xdd, 0xa7, 0x86, 0x79 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMsWheaPkgTokenSpaceGuid = { 0x9b859fdb, 0xcae9, 0x44f8, { 0x80, 0x86, 0xbb, 0xc0, 0xb2, 0x69, 0x3a, 0x1d } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdMsWheaReportEarlyStorageCapacity = _PCD_VALUE_PcdMsWheaReportEarlyStorageCapacity;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdMsWheaEarlyStorageDefaultValue = _PCD_VALUE_PcdMsWheaEarlyStorageDefaultValue;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdDeviceIdentifierGuid[16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdDeviceIdentifierGuid = 16;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdMsWheaRSCHandlerTpl = _PCD_VALUE_PcdMsWheaRSCHandlerTpl;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdVariableHardwareMaxCount = _PCD_VALUE_PcdVariableHardwareMaxCount;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdVariableHardwareErrorRecordAttributeSupported = _PCD_VALUE_PcdVariableHardwareErrorRecordAttributeSupported;
...
{
  return MsWheaReportDxeEntry (ImageHandle, SystemTable);
}
