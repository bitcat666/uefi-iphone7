...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x50670071, 0x478f, 0x4be7, {0xad, 0x13, 0x87, 0x54, 0xf3, 0x79, 0xc6, 0x2f}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MsBootPolicy";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAltBootGuid = {0x26D75FF0, 0xD5CD, 0x49EC, {0x80, 0x92, 0xF8, 0xEC, 0x4D, 0x18, 0xEF, 0x33}};
...
{
  return MsBootPolicyEntry (ImageHandle, SystemTable);
}
