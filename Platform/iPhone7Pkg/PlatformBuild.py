# @file
# Script to Build iPhone 7 Mu UEFI firmware 
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("iPhone7Pkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('iPhone7', 'gcc_aarch64_linux', 'edk2-build')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetActiveScopes(self):
        # Remove dependency-checking scopes
        scopes = super().GetActiveScopes()
        return [s for s in scopes if 'cibuild' not in s and 'plugin' not in s.lower() and 'codeql' not in s.lower()]
    
    def GetRequiredSubmodules(self):
        return []  # Skip submodule checks too
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "iPhone7Pkg/iPhone7.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "iPhone7", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "iPhone7Pkg/iPhone7.dsc", "Platform Hardcoded")
